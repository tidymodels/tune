...
The goal of tune is to facilitate the tuning of hyperparameters the tidymodels packages. It replies heavily on `recipes`, `parsnip`, and `dials`. 
...
The pkgdown site has some examples (and other resources):
