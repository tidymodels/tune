...
test_that("verifying loop_over_all_stages, no submodels, tuning, no estimation, extract", {
  ...
  static_1 <- tune:::make_static(
    ...
    eval_time = NULL,
    split_args = rs_args,
    control = control_grid(extract = ext_1)
  )
...
test_that("verifying loop_over_all_stages, submodels, tuning, no estimation, extract", {
  skip_if_not_installed("modeldata")
  skip_if_not_installed("kknn")
  skip_if_not_installed("probably")
  ...
  ctrl <- tune::control_grid(extract = ext_1)
...
test_that("verifying loop_over_all_stages, submodels only, tuning, no estimation, extract", {
  skip_if_not_installed("modeldata")
  skip_if_not_installed("kknn")
  skip_if_not_installed("probably")
