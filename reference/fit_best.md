...
- x:
  ...
  [`save_workflow = TRUE`](https://tune.tidymodels.org/reference/control_grid.md)
...
- parameters:
  ...
  [`select_best(metric, eval_time)`](https://tune.tidymodels.org/reference/show_best.md).
...
[`last_fit()`](https://tune.tidymodels.org/reference/last_fit.md) is
...
[`last_fit()`](https://tune.tidymodels.org/reference/last_fit.md) gives
you the performance results. If you want the fitted workflow, you can
extract it from the result of
[`last_fit()`](https://tune.tidymodels.org/reference/last_fit.md) via
