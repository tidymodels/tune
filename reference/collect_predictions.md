...
- x:
  ...
  or [`last_fit()`](https://tune.tidymodels.org/reference/last_fit.md).
...
functions](https://tune.tidymodels.org/reference/control_grid.md). The
function returns a tibble with columns for the resampling indicators,
the location (preprocessor, model, etc.), and extracted objects.
...
[control
function's](https://tune.tidymodels.org/reference/control_grid.md)
