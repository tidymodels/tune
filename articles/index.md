...
- [Acquisition
  functions](https://tune.tidymodels.org/articles/acquisition_functions.md):
...
- [Optimizations and parallel
  processing](https://tune.tidymodels.org/articles/extras/optimizations.md):

  How can we evaluate candidate models in the shortest amount of time?

- [Introduction to tune](https://tune.tidymodels.org/articles/tune.md):
