...
#' @param control A control object created by `ctrl_Bayes()`
...
#' @seealso `ctrl_Bayes()`, `tune()`, `estimate.tune_results()`,
#' `autoplot.tune_results()`, `show_best()`, `select_best()`,
#' `collect_predictions()`, `collect_metrics()`, `prob_improve()`,
#' `exp_improve()`, `conf_bound()`
#' @details
#'
  ...
  tmp_res <-
    try(
      tune_grid(
        ...
        grid = candidates,
        metrics = metrics,
        control = ctrl_grid(verbose = FALSE, extract = control$extract,
